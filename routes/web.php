...
//Edited Hackathon Routes @Start

use App\Http\Controllers\Controller;
Route::post('/send-helpdesk-email', [Controller::class, 'sendHelpDeskEmail'])->name('sendHelpDeskEmail');
Route::get('/email-form', [Controller::class, 'showForm'])->name('emailForm');

//@End Hackathon Edited Routes
