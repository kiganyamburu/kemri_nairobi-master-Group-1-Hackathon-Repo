                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class=""><button class="dropdown-item">Complaints/Reports</button></li>
            ...
            <ul class="nav navbar-nav no-borders">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class=""><button onclick="openReportsForm()" class="dropdown-item">Complaints/Reports</button></li>
                        ...
                        <script>
                            ...
                            // Show the form container when the page loads
                            ...
                            // Wait for the page to load and then call openReportsForm()
                    ...
                    <div id="form-container">
                        ...
                        <form id="helpdesk-email-form" onsubmit="submitForm(event)">
                            ...
                            <input class="btn w-100 submit-report" type="submit" value="Send Email">
                        </form>
                    </div>
