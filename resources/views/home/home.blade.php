        ...
        <div class="row">
		    ...
		    <div class="col-lg-6">
		        <div class="hpanel">
					...
					<!-- Start Hackathon Widget Test Complete
					...
					<button id="floating-btn" onclick="toggleForm()">+</button>

					<div id="form-container">
						<h1>Send Helpdesk Email</h1>
						...
						<form action="{{ route('sendHelpDeskEmail') }}" method="POST">
							@csrf
