...
use App\Mail\HelpDeskEmail;
use Illuminate\Foundation\Bus\DispatchesJobs;
use Illuminate\Routing\Controller as BaseController;
use Illuminate\Foundation\Validation\ValidatesRequests;
use Illuminate\Foundation\Auth\Access\AuthorizesRequests;

//@Start hackathon IMPORTS
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Mail;
//@End hackathon Imports

class Controller extends BaseController
{
    use AuthorizesRequests, DispatchesJobs, ValidatesRequests;

    //@Start hackathon Functions
    public function sendHelpDeskEmail(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        Mail::send(new HelpDeskEmail($data));

        return redirect()->back()->with('success', 'Email sent to Helpdesk successfully!');
    }
